...
#include "screen_size"  // I cant disable this warning, smh
...
// also im probably using the layout things wrong, im not supposed to use layout (location=) syntax in frag input
